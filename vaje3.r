...
#Preveri, zakaj take stevilke v oklepajih.
...
#histogram N1
pov.N1 <- mean(N1) #povprecje vrednosti N1
...
#Na grafu manjka rdeča crtkana crta.

#histogram N2
pov.N2 <- mean(N2) #povprecje vrednosti N1
...
#Manjka rdeca crtkana crta in zelene puscice vstran.

#histogram N3
pov.N3 <- mean(N3) #povprecje vrednosti N1
